...
public class SAHv1 {
     ...
     */
    public SAHv1(String SPFilename, String parcelFilename, String outputFilename, String properties) {
     ...
     */
    private boolean canMerge(int start, int end, List<Integer> routeStart, List<Integer> routeEnd,
                             HashMap<Integer, int[]> sizesPerLocation, HashMap<Integer, ArrayList<Long>> parcelsPerLocation) {

        // checking if smartPoint i from saving pair(i,j) is interior //
        for (int i = 0; i < routeStart.size(); i++){
            if (routeStart.get(i) == start &&  (i != 1 || i != routeStart.size() - 2))
                return false;
        }

        // checking if smartPoint j from saving pair(i,j) is interior //
        ...
        // that's the reason we cannot merge routes of interior smartPoints //
    ...
    public static void main(String[] args) {
        ...
        SAHv1 vrp = new SAHv1(SPFilename,parcelFilename,outputFile,mipProperties);
        vrp.execute();
    }
}
