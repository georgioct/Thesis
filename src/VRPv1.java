...
public class VRPv1 {
     ...
     */
    public VRPv1(String SPFilename, String parcelFilename, String outputFilename, String properties) {
    ...
    private void loadData(){
        // initialize the SmartPoint and Vehicle parameters from the input file //
    ...
    private void solve() {
        ...
        try (IloCplex cplex = new IloCplex()) {
            ...
            System.out.println("\nConstraint 6: Each parcel once it arrives at SPi == parcelLocation[i] must be delivered to it.");
    ...
    public static void main(String[] args) {
        ...
        VRPv1 vrp = new VRPv1(SPFilename,parcelFilename,outputFile,mipProperties);
        vrp.execute();
    }
}